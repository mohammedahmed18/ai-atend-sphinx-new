                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('appointment.update',$appointment->id)}}" method="post">
                           ...
                           <div class="row">
                            ...
                            <input data-toggle="touchspin" type="text" value="{{$appointment->delay_min}}" name="delay_min"  >
                            </div>
                            <div class="form-group col-6">
                            <label>delay Hours</label>
                            <input data-toggle="touchspin" type="text" value="{{$appointment->delay_hour}}" name="delay_hour" >
                           </div></div>
                           <div class="row">
                            <div class="form-group col-6">
                            <label>overtime min</label>
                            <input data-toggle="touchspin" type="text" value="{{$appointment->overtime_min}}" name="overtime_min"   >
                            </div>
                            <div class="form-group col-6">
                            <label>overtime Hours</label>
                            <input data-toggle="touchspin" type="text" value="{{$appointment->overtime_hour}}" name="overtime_hour"   >
                           </div></div>
                           <div class="form-group mb-3">
