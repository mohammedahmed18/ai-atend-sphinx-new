        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit Plan "{{ $plan->name_en }}"</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('plans.update', $plan->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" name="name_en" class="form-control" id="name_en"
                                    value="{{ $plan->name_en }}" placeholder="Name en">
                            </div>

                            <div class="form-group">
                                <label for="name" class="col-form-label">Name ar (*)</label>
                                <input type="name" name="name_ar" class="form-control" id="name_ar"
                                    value="{{ $plan->name_ar }}" placeholder="Name ar">
                            </div>

                            <div class="form-group">
                                <label for="name" class="col-form-label">max employee</label>
                                <input type="name" name="max_emp" class="form-control" id="max_emp"
                                    value={{ $plan->max_emp }} placeholder="max emp">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="activate" id="">
                                    ...
                                    <option {{ $plan->activate ? 'selected' : '' }} value="1">Active</option>
                                    <option {{ !$plan->activate ? 'selected' : '' }} value="0">Not Active</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group shadow-textarea">
                                ...
                                <textarea class="form-control z-depth-1" name="note" id="exampleFormControlTextarea6"
                                    rows="3" placeholder="Write note Here ...">{{ $plan->note }}</textarea>
                            </div>
