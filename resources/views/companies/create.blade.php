                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('companies.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" name="main_address" class="form-control" id="name"   placeholder="mai ddress ...">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" name="commercial_record" class="form-control" id="name"   placeholder="Commercial Record ...">
                            </div>

                            
                            <div class="form-group">
                                <label for="name" class="col-form-label">tax_card</label>
                                <input type="name" name="tax_card" class="form-control" id="name"   placeholder="tax_card ...">
                            </div>
                            
                            <div class="form-group">
                                <label for="name" class="col-form-label">Time-Zone</label>
                                <input type="text" name="timezone" id="input" class="form-control" id="name"   placeholder="timezone ...">
