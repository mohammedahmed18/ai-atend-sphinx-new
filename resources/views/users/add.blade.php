                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('users.store')}}" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name_en" class="form-control" id="nameen" placeholder="Name" required>
                            </div>


                            <div class="form-group">
                                <label for="namear" class="col-form-label">Name (ar)</label>
                                <input type="text" name="name_ar" class="form-control" id="namear" placeholder="Name" required>
                            </div>
