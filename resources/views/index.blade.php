...
<body>
    ...
    <!--Navbar Start-->
    <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark" style="background:#01033c;">
        <div class="container-fluid">
            <!-- LOGO -->
            <a class="logo text-uppercase" href="index.html">
                <img src="{{ asset('assets/images/logo.png') }}" alt="" class="logo-light" height="55" />
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mx-auto navbar-center" id="mySidenav" style="color: white">
    ...
    <section class="bg-home" id="home">
        ...
        <div class="home-center">
            ...
            @if (Session::has('msg_successRegister'))
                        ...
                        <div class="modal-content modal-filled bg-success">
                            <div class="modal-body p-4">
                                <div class="text-center">
                                    ...
                                    <p class="mt-3 text-white">Your request will be reviewed and we will contact you in
                                        3-4 days</p>
                                    <button type="button" class="btn btn-light waves-effect my-2"
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="pr-lg-4">
                                ...
                                <p class="mb-4 pt-2 f-16">Ubold is a fully featured dashboard and admin template comes
                                    with tones of well designed UI elements,
                                    components, widgets and applications and secondary pages.</p>

                                <a href="#demos" class="btn btn-primary btn-lg smooth-scroll"><i
                                        class="fe-eye mr-1"></i> Preview <i class="fe-arrow-right ml-1"></i></a>
                            </div>
                        </div>
                        <div class="col-md-7 text-right">
                            <img src="{{ asset('assets/images/background.jpg') }}" height="10%" width="50%"
                                class="img-fluid shadow-lg animate">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="text-center mb-4 pb-1">
                        ...
                        <p class="text-muted f-15">
                            A clean & modern design with many functionality and features. The clean and well commented
                            code allows easy customization of the theme.</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="features-box">
                        ...
                        <p class="text-muted">
                            Ubold provides handful of different demos (skins) and layout options for different use
                            cases.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="features-box">
                        ...
                        <p class="text-muted">Ready to use apps pages for Chat, CRM, Email, Social Feed, Projects,
                            Tasks, Support Tickets, File Manager, etc.</p>
                    </div>
                </div>
                <!-- end col -->
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="features-box">
                        ...
                        <p class="text-muted">Well-documented and well-commented source to understand the code easily.
                        </p>
                    </div>
                </div>
                <!-- end col -->
                ...
                <div class="col-lg-4">
                    <div class="features-box">
                        ...
                        <p class="text-muted">Get access to premium customer support from the actual people who have
                            created.</p>
                    </div>
                </div>
                <!-- end col -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title text-center mb-3">
                        ...
                        <p class="text-muted f-15">There are six different demos available now with multiple layout
                            options to
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="shadow bg-white mt-4 p-2 rounded">
                        <a href="{{ route('any', ['dashboard']) }}" class="text-dark">
                            <img src="{{ asset('assets/images/landing/demo/layout-1.png') }}" alt=""
                                class="img-fluid mx-auto d-block">
                            <h5 class="mb-0 py-2 text-center">Default (Vertical)</h5>
                            <div class="my-2 text-center">
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('any', ['dashboard']) }}" target="_blank">Light</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'dark']) }}" target="_blank">Dark</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'default-rtl']) }}" target="_blank">RTL</a>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="shadow bg-white mt-4 p-2 animate rounded">
                        <a href="{{ route('second', ['themes', 'creative']) }}" class="text-dark">
                            <img src="{{ asset('assets/images/landing/demo/layout-2.png') }}" alt=""
                                class="img-fluid mx-auto d-block">
                            <h5 class="mb-0 py-2 text-center">Creative (Horizontal)</h5>
                            <div class="my-2 text-center">
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'creative']) }}" target="_blank">Light</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'creative-dark']) }}"
                                    target="_blank">Dark</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'creative-rtl']) }}" target="_blank">RTL</a>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="shadow bg-white mt-4 p-2 animate rounded">
                        <a href="{{ route('second', ['themes', 'material']) }}" class="text-dark">
                            <img src="{{ asset('assets/images/landing/demo/layout-3.png') }}" alt=""
                                class="img-fluid mx-auto d-block">
                            <h5 class="mb-0 py-2 text-center">Material</h5>
                            <div class="my-2 text-center">
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'material']) }}" target="_blank">Light</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'material-dark']) }}"
                                    target="_blank">Dark</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'material-rtl']) }}" target="_blank">RTL</a>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="shadow bg-white mt-4 p-2 animate rounded">
                        <a href="{{ route('second', ['themes', 'modern']) }}" class="text-dark">
                            <img src="{{ asset('assets/images/landing/demo/layout-4.png') }}" alt=""
                                class="img-fluid mx-auto d-block">
                            <h5 class="mb-0 py-2 text-center">Modern (Detached)</h5>
                            <div class="my-2 text-center">
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'modern']) }}" target="_blank">Light</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'modern-dark']) }}" target="_blank">Dark</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'modern-rtl']) }}" target="_blank">RTL</a>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="shadow bg-white mt-4 p-2 animate rounded">
                        <a href="{{ route('second', ['themes', 'saas']) }}" class="text-dark">
                            <img src="{{ asset('assets/images/landing/demo/layout-6.png') }}" alt=""
                                class="img-fluid mx-auto d-block">
                            <h5 class="mb-0 py-2 text-center">Saas (Two-Column)</h5>
                            <div class="my-2 text-center">
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'saas']) }}" target="_blank">Light</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'saas-dark']) }}" target="_blank">Dark</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'saas-rtl']) }}" target="_blank">RTL</a>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="shadow bg-white mt-4 p-2 animate rounded">
                        <a href="{{ route('second', ['themes', 'purple']) }}" class="text-dark">
                            <img src="{{ asset('assets/images/landing/demo/layout-5.png') }}" alt=""
                                class="img-fluid mx-auto d-block">
                            <h5 class="mb-0 py-2 text-center">Purple</h5>
                            <div class="my-2 text-center">
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'purple']) }}" target="_blank">Light</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'purple-dark']) }}" target="_blank">Dark</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                    href="{{ route('second', ['themes', 'purple-rtl']) }}" target="_blank">RTL</a>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="text-center mb-5">
                        <h2 class="mb-1">Frequently Asked Questions</h3>
                            <p class="text-muted f-15">Here are some of the basic types of questions for our customers.
                                For more
            ...
            <div class="row">
                <div class="col-lg-5 offset-lg-1">
                    ...
                    <div>
                        ...
                        <p class="faq-answer mb-4 pb-1">
                            ...
                            information on licenses, please refer <a href="https://themeforest.net/licenses/standard"
                    ...
                    <div>
                        ...
                        <p class="faq-answer mb-4 pb-1">
                            No. This is a HTML template. It won't work directly with wordpress. However you can convert
                            this into wordpress compatible theme.
                        </p>
                    </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div>
                        ...
                        <p class="faq-answer mb-4 pb-1">
                            Yes, We will update the Ubold regularly. All the future updates would be available without
                            any cost.
                        </p>
                    </div>
            ...
            <div class="row mb-0">
                <div class="col-md-4">
                    <div class="pr-lg-4">
                        ...
                        <p class="text">Ubold makes it easier to build better websites with great speed. Save hundreds
                            of hours of design and development by using it.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="float-left pull-none">
                        <p class="">2020 © Ubold. Design by <a href="https://coderthemes.com/" target="_blank"
                                class="">Coderthemes.com</a> </p>
                    </div>
                </div>
                <!-- end col -->
            </div>
