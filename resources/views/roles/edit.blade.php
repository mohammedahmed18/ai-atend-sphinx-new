                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('roles.update' , $role->id)}}" method="post" autocomplete="off" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name-input" placeholder="Name" value="{{$role->name}}" required>
                            </div>

                            <div class="form-group">
                                <label for="inputnotes" class="col-form-label">Notes <span class="text-muted font-weight-light">(optional)</span></label>
