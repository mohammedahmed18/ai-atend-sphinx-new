<!-- Topbar Start -->
<div class="navbar-custom" style="background: #01033c">
    <div class="container-fluid">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown"
                    ...
                    <span class="pro-user-name ml-1">
                        {{ auth()->user()->name_en }} <i class="mdi mdi-chevron-down"></i>
                    </span>
                </a>
        ...
        <div class="logo-box">
            ...
            <a href="{{ route('any', ['dashboard']) }}" class="logo logo-light text-center">
                <span class="logo-sm">
                    <img src="{{ asset('assets/images/ph.jpg') }}" alt="" height="22">
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="" height="55">
                </span>
        ...
        <div class="clearfix" style="background: #01033c"></div>
    </div>
</div>
<!-- end Topbar -->
